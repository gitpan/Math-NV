...
##############################################
  ...
  if(nv($str) == Rmpfr_g(Math::MPFR->new($str), 0)) {print "ok 2\n"}
  else {
    warn "\n2: nv($str):\n", float_bin(nv($str)),
         "\n$got:\n", float_bin(Rmpfr_g(Math::MPFR->new($str), 0)), "\n";
    print "not ok 2\n";
  }
#
  $str = '69659e-292';
  ...
  if(nv($str) == Rmpfr_g(Math::MPFR->new($str), 0)) {print "ok 4\n"}
  else {
    warn "\n4: nv($str):\n", float_bin(nv($str)),
         "\n$got:\n", float_bin(Rmpfr_g(Math::MPFR->new($str), 0)), "\n";
    print "not ok 4\n";
...
#
  ...
  if(nv($str) == Rmpfr_g(Math::MPFR->new($str), 0)) {print "ok 6\n"}
  else {
    warn "\n6: nv($str):\n", float_bin(nv($str)),
         "\n$got:\n", float_bin(Rmpfr_g(Math::MPFR->new($str), 0)), "\n";
    print "not ok 6\n";
...
#
  ...
  if(nv($str) == Rmpfr_g(Math::MPFR->new($str), 0)) {print "ok 8\n"}
  else {
    warn "\n8: nv($str):\n", float_bin(nv($str)),
         "\n$got:\n", float_bin(Rmpfr_g(Math::MPFR->new($str), 0)), "\n";
    print "not ok 8\n";
...
#
  ...
  if(nv($str) == Rmpfr_g(Math::MPFR->new($str), 0)) {print "ok 10\n"}
  else {
    warn "\n10: nv($str):\n", float_bin(nv($str)),
         "\n$got:\n", float_bin(Rmpfr_g(Math::MPFR->new($str), 0)), "\n";
    print "not ok 10\n";
...
#
  ...
  if(nv($str) == Rmpfr_g(Math::MPFR->new($str), 0)) {print "ok 12\n"}
  else {
    warn "\n12: nv($str):\n", float_bin(nv($str)),
         "\n$got:\n", float_bin(Rmpfr_g(Math::MPFR->new($str), 0)), "\n";
    print "not ok 12\n";
...
#
  ...
  for my $exp(10, 20, 30, 280 .. 300) {
    for my $digits(1..$max_dig) {
      $t++;
      my $str = random_select($digits) . 'e' . "-$exp";
      if(float_bin(nv($str)) ne float_bin(Rmpfr_g(Math::MPFR->new($str), 0))) {
        if($count < 5) {
          warn "\$str: $str\n";
          warn "nv($str):\n", float_bin(nv($str)), "\n$got:\n", float_bin(Rmpfr_g(Math::MPFR->new($str), 0)), "\n\n";
        }
